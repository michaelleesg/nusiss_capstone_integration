...
REM Always download stable version (which has the most up-to-date installer)
call :download_file "!GCS_BUCKET!/stable" "!DOWNLOAD_DIR!\stable"
if !ERRORLEVEL! neq 0 (
    echo Failed to get stable version >&2
    exit /b 1
)

REM Read version from file
set /p VERSION=<"!DOWNLOAD_DIR!\stable"
del "!DOWNLOAD_DIR!\stable"
